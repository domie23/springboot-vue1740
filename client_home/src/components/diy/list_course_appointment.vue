<template>
	<div class="diy_home diy_list diy_course_appointment" id="diy_course_appointment_list">
		<!-- 列表 -->
		<div class="diy_view_list list list-x" v-if="show">
			<router-link class="diy_card goods diy_list_box_wrap" v-for="(o, i) in list" :key="i"
				:to="'/course_appointment/details?course_appointment_id=' + o['course_appointment_id']">
				<!-- 图片 -->
				<div class="diy_list_img_box" v-if="imgList.length" >
					<div class="diy_row" v-for="(item,index) in imgList" :key="item+index" v-show="$check_field('get',item.name,'/course_appointment/details') && +item.is_img_list">
				...
				<div class="diy_list_item_box">
					<div class="diy_list_item_content" v-for="(item,index) in showItemList" :key="item+index">
						<div class="diy_row" :class="{[item.name]:true}" v-if="$check_field('get',item.name,'/course_appointment/details') && +item.is_img_list">
							<div class="diy_title">
								<span>{{item.title}}:</span>
							</div>
			...
			<table class="diy_table">
				<tr class="diy_row">
						...
						上课时间
							...
							<th class="diy_title" v-if="$check_field('get','appointment_period')">
						预约时段
					</th>
							<th class="diy_title" v-if="$check_field('get','number_of_appointments')">
						预约数
					</th>
				...
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i">
						...
						<span>
							...
							<td class="diy_field diy_text" v-if="$check_field('get','number_of_appointments')">
						<span>
							{{ o["number_of_appointments"] }}
						</span>
					</td>
							<td class="diy_field diy_uid" v-if="$check_field('get','student_name')">
						<span>
							{{ get_user_name('student_name',o['student_name']) }}
						</span>
					</td>
					</tr>
			</table>
		...
		methods: {
			get_user_name(name,id){
				var obj = null;
					...
					obj = this.list_user_student_name.getObj({"user_id":id});
				}
					var ret = "";
				if(obj){
