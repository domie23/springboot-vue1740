<template>
	<div class="diy_details_box diy_div_experimental_courses">
		<div class="warp">
			<div class="container">
				...
				<div class="row">
					...
					<div class="details_btn_wrap">
											<button class="btn btn-primary details_btn" v-if="$check_action('/course_appointment/edit','add')" @click="to_form('/course_appointment/edit')" > 课程预约 </button>
											<button class="btn btn-primary details_btn" v-if="$check_action('/experimental_courses/details','set')" @click="change_collect()" >收藏</button>
							</div>
						<!-- 富文本 -->
...
<script>
	...
	export default {
      ...
      check_collect() {
        ...
        var experimental_courses_id = this.obj.experimental_courses_id;
        this.$get('~/api/collect/count?', {
          user_id,
          source_table: "experimental_courses",
          source_field: "experimental_courses_id",
          source_id: experimental_courses_id
        }, (res) => {
