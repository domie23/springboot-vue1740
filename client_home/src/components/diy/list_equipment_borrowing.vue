<template>
	<div class="diy_home diy_list diy_equipment_borrowing" id="diy_equipment_borrowing_list">
		<!-- 列表 -->
		<div class="diy_view_list list list-x" v-if="show">
			<router-link class="diy_card goods diy_list_box_wrap" v-for="(o, i) in list" :key="i"
				:to="'/equipment_borrowing/details?equipment_borrowing_id=' + o['equipment_borrowing_id']">
				<!-- 图片 -->
				<div class="diy_list_img_box" v-if="imgList.length" >
					<div class="diy_row" v-for="(item,index) in imgList" :key="item+index" v-show="$check_field('get',item.name,'/equipment_borrowing/details') && +item.is_img_list">
				...
				<div class="diy_list_item_box">
					<div class="diy_list_item_content" v-for="(item,index) in showItemList" :key="item+index">
						<div class="diy_row" :class="{[item.name]:true}" v-if="$check_field('get',item.name,'/equipment_borrowing/details') && +item.is_img_list">
							<div class="diy_title">
								<span>{{item.title}}:</span>
							</div>
			...
			<table class="diy_table">
				<tr class="diy_row">
						...
						借用教师
							...
							<th class="diy_title" v-if="$check_field('get','borrowed_quantity')">
						借用数量
					</th>
							<th class="diy_title" v-if="$check_field('get','contact_information')">
						联系方式
					</th>
							<th class="diy_title" v-if="$check_field('get','borrowing_date')">
						借用日期
					</th>
							<th class="diy_title" v-if="$check_field('get','borrowing_instructions')">
						借用说明
					</th>
					</tr>
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i">
						...
						<span>
							...
							<td class="diy_field diy_number" v-if="$check_field('get','borrowed_quantity')">
						<span>
							{{ o["borrowed_quantity"] }}
						</span>
					</td>
						...
						<span>
							...
							<td class="diy_field diy_date" v-if="$check_field('get','borrowing_date')">
						<span>
							{{ $toTime(o["borrowing_date"] ,"yyyy-MM-dd") }}
						</span>
					</td>
							<td class="diy_field diy_text" v-if="$check_field('get','borrowing_instructions')">
						<span>
							{{ o["borrowing_instructions"] }}
						</span>
					</td>
					</tr>
			</table>
