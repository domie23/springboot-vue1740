<template>
	<div class="diy_details_box diy_div_laboratory_information">
		<div class="warp">
			<div class="container">
				...
				<div class="row">
					...
					<div class="details_btn_wrap">
								<button class="btn btn-primary details_btn" v-if="$check_action('/laboratory_information/details','set')" @click="change_praise()" >点赞</button>
							</div>
						<!-- 富文本 -->
